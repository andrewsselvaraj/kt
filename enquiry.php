...
{
var a=document.forms["Enquiry"]["name"].value;
var b=document.forms["Enquiry"]["phone"].value;
var c=document.forms["Enquiry"]["mailid"].value;
var d=document.forms["Enquiry"]["message"].value;
var e=document.forms["Enquiry"]["6_letters_code"].value;
var atpos=c.indexOf("@");
...
<h2 class="under" align=center>Enquiry</h2>
				
						<form id="Enquiry" name=Enquiry action=mail.php method="post"onsubmit="return validateForm();">
						...
						<tr><td>
							...
							<tr><td><span>Your Enquiry:</span></td><td>
...
<td><input id="6_letters_code" name="6_letters_code" type="text"><br></td>
							...
							<tr><td><br></td><td><input type=submit value=send title="Add row" class="button_add">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=reset value=reset title="Add row" class="button_add"></td>
							</tr>
