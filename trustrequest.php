...
if (isset($_SESSION['email_id'])) {
        header('Location: trash_login.php');
		}
?><head>
<style>
...
<tr>
<td style="padding-left:12px; font-size:20px"><b>Trash Request</b></td>
...
<tr>
<input id="tems" name="tems" type="hidden" /><input id="trash" name="trash" type="hidden"  value="Trash"/>
</tr>
<BR>
<tr >
<td align="left">
...
<tr><input id="items" name="items" type="hidden" /> <input id="trash" name="trash" type="hidden"  value="Trash"/>
</tr>
<BR>
<tr>
<td align="left">E-Mail Id (User Name)</td>
